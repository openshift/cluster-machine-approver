...
import (
	...
	"github.com/openshift/cluster-machine-approver/tools/junitreport/pkg/api"
		...
		},
		{
			...
			expectedSuites: &api.TestSuites{
				Suites: []*api.TestSuite{
					...
					{
						Name:       "github.com/openshift/cluster-machine-approver/tools/junitreport/pkg/parser/gotest/example",
						NumTests:   19,
						NumFailed:  9,
						Duration:   0.006,
