...
const (
	rootPackage = "github.com/openshift/service-serving-cert-signer"
)
...
func (i *ImportRestriction) isRestrictedPath(packageToCheck string) bool {
	...
	// github.com/openshift/service-serving-cert-signer or github.com/openshift/cluster-machine-approver/vendor
